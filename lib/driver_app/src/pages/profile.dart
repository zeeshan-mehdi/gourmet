...
class DriverProfileWidget extends StatefulWidget {
  ...
  DriverProfileWidget({Key key, this.parentScaffoldKey}) : super(key: key);

  @override
  _DriverProfileWidgetState createState() => _DriverProfileWidgetState();
}

class _DriverProfileWidgetState extends StateMVC<DriverProfileWidget> {
  ProfileController _con;

  _DriverProfileWidgetState() : super(ProfileController()) {
    _con = controller;
  }
