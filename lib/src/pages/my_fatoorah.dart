...
class MyFatoorah extends StatefulWidget {
  ...
  const MyFatoorah({Key key, this.routeArgument}) : super(key: key);
  @override
  _MyFatoorahState createState() => _MyFatoorahState();
}

class _MyFatoorahState extends StateMVC<MyFatoorah> {

  MyFatoorahController _con;

  _MyFatoorahState() : super(MyFatoorahController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    print('i am inside my fatoorah payment');
    _con.payment = new Payment.fromJSON({'method':'My Fatoorah'});
    _con.listenForCarts();
    super.initState();

    // WidgetsBinding.instance
    //     .addPostFrameCallback((_) => ('i am running '));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: _con.carts.isEmpty && _con.loading
