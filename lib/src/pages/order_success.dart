...
class _OrderSuccessWidgetState extends StateMVC<OrderSuccessWidget> {
  ...
  void initState() {
    ...
    print('parameters order success : ${widget.routeArgument.param}');
...
// class NotNecessaryCode extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Container(
//       child:Stack(
...
//                   opacity: 0.4,
//                   child: Text(
//                     _con.autoAccept==false && _con.isPaid ? S.of(context).your_order_request_has_been_successfully_submitted : S.of(context).your_order_has_been_successfully_submitted,
