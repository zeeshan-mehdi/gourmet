...
@override
  void initState() {
    ...
    isPaid = widget.routeArgument.param['isPaid'];
    autoAccept = widget.routeArgument.param['autoAccept'];

    print('isPaid $isPaid       -- autoAccept $autoAccept');
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListView.separated(
              ...
              shrinkWrap: true,
              primary: false,
              itemCount: isPaid  && autoAccept ? list.paymentsList.length  :list.kitchenList.length,
              separatorBuilder: (context, index) {
                return SizedBox(height: 10);
              },
              itemBuilder: (context, index) {
                return PaymentMethodListItemWidget(paymentMethod: isPaid && autoAccept ? list.paymentsList.elementAt(index) : list.kitchenList.elementAt(index),arg:{'isPaid':isPaid,'autoAccept':autoAccept,'method':''});
              },
            ),
            // ListView.separated(
            //   scrollDirection: Axis.vertical,
