...
class _MessageItemWidgetState extends State<MessageItemWidget> {
  ...
  Widget build(BuildContext context) {
    String thumbnailUrl =  this.widget.message.users?.firstWhere((element) => element.id != currentUser.value.id,orElse: () => null)?.image?.thumb??'';
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Stack(
                children: <Widget>[
                  this.widget.message.users.length>0 ? SizedBox(
                    width: 60,
                    height: 60,
                    child: ClipRRect(
