...
class EmptyKitchenCartWidget extends StatefulWidget {
  EmptyKitchenCartWidget({
    Key key,
  }) : super(key: key);

  @override
  _EmptyKitchenCartWidgetState createState() => _EmptyKitchenCartWidgetState();
}

class _EmptyKitchenCartWidgetState extends State<EmptyKitchenCartWidget> {
  bool loading = true;
