...
class PaymentMethodListItemWidget extends StatelessWidget {
  ...
  PaymentMethodListItemWidget({Key key, this.paymentMethod,this.arg}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        ...
        //   Navigator.of(context).pushNamed(this.paymentMethod.route,arguments: RouteArgument(param: arg));
        // else
