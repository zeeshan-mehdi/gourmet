...
class S {
  ...
  /// `Your order has been successfully submitted!`
  String get your_order_request_has_been_successfully_submitted {
    return Intl.message(
      'Your order Request has been successfully submitted, you will be notified if kitchen accepts or declines order!',
      name: 'your_order_request_has_been_successfully_submitted',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Kitchen Managed `
  String get kitchen_managed {
    return Intl.message(
      'Kitchen Managed Payment',
  ...
  /// `Click to pay with your PayPal account`
  String get click_to_pay_with_my_fatoorah {
    return Intl.message(
      'Click to pay with My Fatoorah',
      name: 'click_to_pay_with_my_fatoorah',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Click to pay cash on delivery`
  String get click_to_select_kitchen_managed {
    return Intl.message(
      'Click to Selet Kitchen Managed',
      name: 'click_to_select_kitchen_managed',
      desc: '',
      args: [],
    );
  }
